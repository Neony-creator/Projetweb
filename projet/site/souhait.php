...
<?php
$dsn = 'mysql:dbname=projetweb;host=localhost';                /*Chaine de connexion avec IP et BDD */
...
if (!$error) {
    $query = $bdd->prepare('SELECT name_offer, company_name, skills, trust_of_pilot, sector_of_activity, Town, internship_duration, start_date, remuneration_basis, number_of_places_offered FROM offer NATURAL JOIN location NATURAL JOIN company NATURAL JOIN evaluate;');
    $query->execute();
